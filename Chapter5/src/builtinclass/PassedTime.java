...
public class PassedTime {
	...
	public static void main(String[] args) {
		...
		startDay.set(2022, 5, 9);  //시작일 지정
		today.set(2022, 6, 29);    //현재일 지정
		
		//날짜 출력
		String startDay1 = startDay.get(Calendar.YEAR) + "년 " + startDay.get(Calendar.MONTH) + "월 "
				+ startDay.get(Calendar.DATE) + "일";
		String today1 = today.get(Calendar.YEAR) + "년 " + today.get(Calendar.MONTH) + "월 "
